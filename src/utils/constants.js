...
export const SUCCES_REGISTRATION_MESSAGE = 'Вы успешно зарегистрировались!';
...
export const SIGN_IN_MESSAGE= 'Войдите в личный кабинет чтобы добавлять фильмы в избранное';
